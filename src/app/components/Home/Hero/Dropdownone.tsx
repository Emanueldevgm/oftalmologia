...
const Dropdown = () => {
  const [course, setCourse] = useState<ServiceType[]>([])
  const [selected, setSelected] = useState<ServiceType | null>(null)

  useEffect(() => {
    // Sample data - replace with API call if needed
    const sampleData: ServiceType[] = [
      { id: '1', name: 'Consulta Oftalmológica' },
      { id: '2', name: 'Exame de Refração' },
      { id: '3', name: 'Cirurgia de Catarata' },
      { id: '4', name: 'Tratamento de Glaucoma' },
    ]
    setCourse(sampleData)
    setSelected(sampleData[0])
  }, [])

  return (
    <div className='w-full'>
      <p className='text-lg text-gray-500'>Qual serviço deseja?</p>
